...
BEGIN
    FOR i IN 2..30 LOOP
        INSERT INTO instock values (DEFAULT, i,  floor(random() * 101)::integer, (floor(random() * 101)::numeric + 100)::integer);
    END LOOP;
END$$;

INSERT INTO gamestylesdist values (DEFAULT, 23, 63, 14, 0, 0);
INSERT INTO trainers values (DEFAULT,'Ash', 'Some', 'MALE', 1, 1);
...
INSERT INTO trainers values (DEFAULT, 'Aqua', 'Kim', 'MALE', 2, 2);
